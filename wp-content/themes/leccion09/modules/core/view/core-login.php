         ...
         <div class="ingreso-bg p-5 rounded-5 shadow" style="margin-top:-2.3rem; width:20rem;">
            <form class="needs-validation float" id="ingreso" novalidate>
               ...
               <div class="d-flex form-floating mb-3 border-bottom">
                  ...
                  <span class="mt-4" style="font-size: 70%;"><i id="ver_clave" class="fa-solid fa-eye"></i></i></span>
               </div>
               <div class="mb-4">
               ...
               <div class="text-center form-group">
                  <button id="btn_login" type="submit" name="ingreso" class="btn btn-warning btn-sm mb-3"><i class="fas fa-sign-in-alt"></i>
                     Ingresar</button>
               </div>
