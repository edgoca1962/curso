   ...
   <?php if (have_comments()) : ?>
      ...
      <?php if (get_comment_pages_count() > 1 && get_option('page_comments')) : ?>
         <nav class="navigation comment-navigation" role="navigation">
            <h1 class="screen-reader-text section-heading"><?php _e('Comment navigation', 'MYDOMAIN'); ?></h1>
            <div class="nav-previous"><?php previous_comments_link(__('&larr; Comentarios antigüos', 'MYDOMAIN')); ?></div>
            <div class="nav-next"><?php next_comments_link(__('Nuevos comentarios &rarr;', 'MYDOMAIN')); ?></div>
         </nav><!-- .comment-navigation -->
      <?php endif; // Check for comment navigation 
      ?>

      <?php if (!comments_open() && get_comments_number()) : ?>
         <p class="no-comments"><?php _e('Comments are closed.', 'MYDOMAIN'); ?></p>
      <?php endif; ?>
   ...
   $defaults = array(
      ...
      'must_log_in'          => sprintf(
         ...
         sprintf(
            ...
            __('Tienes que estar <a href="%s">registrado</a> para incluir un comentario.', 'MYDOMAIN'),
      ...
      'logged_in_as'         => sprintf(
         ...
         sprintf(
            ...
            esc_attr(sprintf(__('Autor(a): %s. Editar perfil.', 'MYDOMAIN'), $user_identity)),
            $user_identity,
            // /** This filter is documented in wp-includes/link-template.php 
      ...
      'name_submit'          => 'submit',
      'title_reply'          => __('Comentario de seguimiento', 'MYDOMAIN'),
      'title_reply_to'       => __('Comentario de seguimiento a %s', 'MYDOMAIN'),
      'title_reply_before'   => '<h3 id="reply-title" class="comment-reply-title">',
      'title_reply_after'    => '</h3>',
      'cancel_reply_before'  => ' <small>',
      'cancel_reply_after'   => '</small>',
      'cancel_reply_link'    => __('Cancel reply', 'MYDOMAIN'),
      'label_submit'         => __('Incluir comentario', 'MYDOMAIN'),
