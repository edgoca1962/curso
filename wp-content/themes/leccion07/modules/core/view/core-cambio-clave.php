...
<section class="d-flex justify-content-center pt-5">
   <div class="col-md-6">
      <form id="cambiar_clave" class="row g-3 needs-validation float" novalidate>
         <div id="clave_actual" class="d-flex form-floating mb-3 border-bottom">
         ...
         <div id="clave_nueva" class="d-flex form-floating mb-3 border-bottom">
         ...
         <div id="confirmar_clave" class="d-flex form-floating mb-3 border-bottom">
